...
faltas2 = bool(int(input("Digite 1 se faltou na segunda disciplina ou 0 se não faltou: ")))
...
if(faltas1 and faltas2):
    ...
    if(nota1 >= 60 and nota2 >= 60):
        ...
        print("Aprovado apenas na primeira disciplina.")
    elif(nota1 < 60 and nota2 >= 60):
        print("Aprovado apenas na segunda disciplina.")
    else:
